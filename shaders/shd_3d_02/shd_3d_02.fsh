...
#region		//(is_material == 1.)
			if (is_material == 1.)//first noisy material
				{
					//v_ref_space_pos, obj_hash,	v_vTexcoord
...
#region		//(is_material == 2.) //no color change just noise in normal
			if (is_material == 2.)//first noisy material
				{
...
#region		//(is_material == 3.) //for now any material
			if (is_material == 3.)//first noisy material
				{
					//v_ref_space_pos, obj_hash,	v_vTexcoord
					float _div = 4.;
...
#region		//(is_material == 9.)//cros shading color chaos
			if (is_material == 9.)//cros shading try
				{
					//v_ref_space_pos, obj_hash,	v_vTexcoord
...
#region		//(is_material == 4.)
			if (is_material == 4.)//first noisy material
				{
					//v_ref_space_pos, obj_hash,	v_vTexcoord
					float _div = 32.;
					float _nearest_x1 = 0.;	float _nearest_y1 = 0.;	float _nearest_z1 = 0.;
...
#region		//(is_material == 5.)
			if (is_material == 5.)//first noisy material
				{
					//v_ref_space_pos, obj_hash,	v_vTexcoord
					float _div = 32.;
					float _nearest_x1 = 0.;	float _nearest_y1 = 0.;	float _nearest_z1 = 0.;
...
#region		//(is_material == 6.)
			if (is_material == 6.)//first noisy material
				{
					//v_ref_space_pos, obj_hash,	v_vTexcoord
					float _div = 32.;
					float _nearest_x1 = 0.;	float _nearest_y1 = 0.;	float _nearest_z1 = 0.;
...
#region		//(is_material == 7.)
			if (is_material == 7.)//first noisy material
				{
					//v_ref_space_pos, obj_hash,	v_vTexcoord
					float _div = 64.;
...
#region		//(is_material == 8.)
			if (is_material == 8.)//first noisy material
				{
					//v_ref_space_pos, obj_hash,	v_vTexcoord
					float _div = 32.;
	...
	if (	(color_texture_set < 0.)	&& (is_material != 9.)	)
		{
