function exe_add_object_terrain_04()
{
	//3d obj start
	var _temp_o = {};
	...
	_temp_o.part_vbuff_load_reference =			[	["vbuff_terrain_04","N","N"]				];
	_temp_o.part_texture_shader_setings =		[	[0.]			];	//material true/false
	
	_temp_o.part_vbuff_colider_load_reference = [	["vbuff_terrain_04","N","N"]				];
