function exe_add_door_01(_initial_pm)
{
	//3d obj start
	var _temp_o = {};
	...
	if _initial_pm == undefined
		{
			var _push_pos = [1879,3197,851,	180,0,0,	1,1,1];
			var _posMat = exe_return_initial_posMat(_push_pos);
		}
	else	{var _posMat = _initial_pm;};

	_temp_o.character_sheet = {		name: "doors_01", hash: exe_return_hash(	string_join("|",current_time,date_current_datetime(),map3d)	),
	...
	_temp_o.part_vbuff_load_reference =			[	["vbuff_doors_1_wall","1.","N"],					["vbuff_doors_1","1.","N"],							["vbuff_empty","1.","N"]								];
	_temp_o.part_texture_shader_setings =		[	[0.,1.],											[0.,1.],											[0.,1.]													];	//material true/false
	
	_temp_o.part_vbuff_colider_load_reference = [	["vbuff_doors_1_wall","1.","N"],					["vbuff_doors_1","1.","N"],							["vbuff_doors1_activator","1.","N"]						];
