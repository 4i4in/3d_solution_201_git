				...
				switch(menus.graphic_control.split_screen)
					{
						...
						case "vertical":
							...
							if surface_exists(cam_struct.cam1.surf_postproces_croshatch)	{draw_surface_ext(cam_struct.cam1.surf_postproces_croshatch,0,dgh/2,2,2,0,-1,1);};
						...
						case "horizontal":	
							if surface_exists(cam_struct.cam1.surf_color)	{draw_surface(cam_struct.cam1.surf_color,0,0);};
							if surface_exists(cam_struct.cam1.surf_postproces_normals)	{draw_surface(cam_struct.cam1.surf_postproces_normals,dgw/2,0);};
							if surface_exists(cam_struct.cam1.surf_postproces_croshatch)	{draw_surface_ext(cam_struct.cam1.surf_postproces_croshatch,0,dgh/4,2,2,0,-1,1);};
