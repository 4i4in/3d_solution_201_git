function exe_add_object_terrain_03()
{
	//3d obj start
	var _temp_o = {};
	
	var _push_pos = [1000,1000,0,	180,0,0,	1,1,1];
	var _posMat = exe_return_initial_posMat(_push_pos);



	_temp_o.character_sheet = {		name: "terrain_03", hash: exe_return_hash(	string_join("|",current_time,date_current_datetime(),map3d)	),
									file_name : "terrain_03.txt", file_directory : "terrain/",};
	...
	_temp_o.part_vbuff_load_reference =			[	["vbuff_terrain_03","N","N"]				];
	_temp_o.part_texture_shader_setings =		[	[1.]			];	//material true/false
	
	_temp_o.part_vbuff_colider_load_reference = [	["vbuff_terrain_03","N","N"]				];
