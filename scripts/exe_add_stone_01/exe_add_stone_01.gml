function exe_add_stone_01(_initial_pm)
{
	//3d obj start
	var _temp_o = {};
	...
	if _initial_pm == undefined
		{
			var _push_pos = [2034,3265,799,	180,0,0,	1,1,1];
	...
	_temp_o.character_sheet = {		name: "stone_01", hash: exe_return_hash(	string_join("|",current_time,date_current_datetime(),map3d)	),
									file_name : "stone_01.txt", file_directory : "terrain/",};
	...
	_temp_o.part_vbuff_load_reference =			[	["vbuff_stone_01_show","N","N"]						];
	_temp_o.part_texture_shader_setings =		[	[1.,1.]			];	//material true/false
	
	_temp_o.part_vbuff_colider_load_reference = [	["vbuff_stone_01_colider","N","N"]						];
