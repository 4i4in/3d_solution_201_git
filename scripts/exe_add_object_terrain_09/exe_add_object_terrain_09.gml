function exe_add_object_terrain_09()
{
	...
	_temp_o.character_sheet = {		name: "terrain_04", hash: exe_return_hash(	string_join("|",current_time,date_current_datetime(),map3d)	),
	...
	_temp_o.part_vbuff_load_reference =			[	["vbuff_terrain_09a","N","N"],["vbuff_terrain_09b","N","N"],["vbuff_terrain_09c","N","N"],["vbuff_terrain_09d","N","N"]				];
	_temp_o.part_texture_shader_setings =		[	[1.,1.],[7.,1.],[3.,1.],[8.,1.]			];	//material true/false
	
	_temp_o.part_vbuff_colider_load_reference = [	["vbuff_terrain_09a","N","N"],["vbuff_terrain_09b","N","N"],["vbuff_terrain_09c","N","N"],["vbuff_terrain_09d","N","N"]				];
	...
	_temp_o.part_vbuff_helper_load_reference =	[	["vbuff_dir_arrow","50.","N"],["vbuff_dir_arrow","50.","N"],["vbuff_dir_arrow","50.","N"],["vbuff_dir_arrow","50.","N"]					];
